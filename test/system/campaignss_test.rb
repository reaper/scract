rcequire "application_system_test_case"
...
class CampaignsTest < ApplicationSystemTestCase
  ...
  test "should create campaign" do
    ...
    fill_in "Schedule", with: @campaign.schedule
    fill_in "Scheduled with", with: @campaign.scheduled_with
    fill_in "Script", with: @campaign.script
